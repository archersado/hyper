...
import getHostConfig from '../reconciler';
import generateUUID from '../utils/uuid';
import { RenderObject, EngineManager } from '@hset/hyper-core';
...
export default function getContainer(hyperManager: EngineManager) {
    const ReactRconcilerHyper = ReactFiberReconciler(getHostConfig(hyperManager));
    const BoardWarp = (props: any) => {
        ...
        useLayoutEffect(() => {
            canvas.current = document.getElementById(containerId);
    ...
    return forwardRef((props, ref) => <BoardWarp {...props} forwardRef={ref} />)
}